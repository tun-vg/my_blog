        ...
        <>
            <div className='w-full'>
                ...
                <div className='flex gap-x-5 mt-2'>
                    {data.map((p) => {
                        return <div key={p.postId} className='h-fit w-56 flex flex-col gap-y-3 bg-gray-300'>
                            <img src='https://lh7-rt.googleusercontent.com/docsz/AD_4nXcvDH5qqP55rOehebEQChMCroH0U6PAvG55-o-eRHARHz1CifVLkoziLUDwE326CSAB4ch6sGHOu2W8BaiInFCfijcCTVCkt6M-LdQ0FnlOAU755T05ZqoIQLAkCPH2E8Glhg3Qnw?key=E_klvQY5pnbczCrBuwbNLg' alt='image' className='h-36 w-56 rounded-lg' />
