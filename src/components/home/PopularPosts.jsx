        ...
        <>
            <div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    {favPost?.map(p => {
                        return <div key={p.postId} className='flex gap-x-4 mt-2 mb-2 bg-gray-300' onClick={() => navigate(`/bai-dang/${p.postId}/${p.slug}`)}>
                            <img src='https://lh7-rt.googleusercontent.com/docsz/AD_4nXcvDH5qqP55rOehebEQChMCroH0U6PAvG55-o-eRHARHz1CifVLkoziLUDwE326CSAB4ch6sGHOu2W8BaiInFCfijcCTVCkt6M-LdQ0FnlOAU755T05ZqoIQLAkCPH2E8Glhg3Qnw?key=E_klvQY5pnbczCrBuwbNLg' alt='image' className='h-28 w-28' />
